...
class ProductLabelLayout(models.TransientModel):
    ...
    print_format = fields.Selection(selection_add=[
        ...
        ('label_muebles_2_1', '2 x 1 Muebles Plegables'),
        ], ondelete={'label_alnu_3_2': 'set default', 'label_muebles_2_1': 'set default'})
    ...
    def _prepare_report_data(self):
            ...
            if self.move_line_ids:
                for linea in self.move_line_ids:
                    ...
                    if linea.product_id.id in dicc_products_price:
                        ...
                        'cantidad': linea.product_uom_qty + linea.qty_done,
        ...
        if self.print_format == 'label_muebles_2_1':
            xml_id = 'agro.action_report_product_ali_mueble_label_01'
            #Sirve cuando si imprime desde la opcion de Productos /   Lotes
            if self.move_line_ids:
                for linea in self.move_line_ids:
